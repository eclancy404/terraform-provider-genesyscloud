...
/*
The genesyscloud_conversations_messaging_integrations_whatsapp_init_test.go file is used to initialize the data sources and resources
used in testing the conversations_messaging_integrations_whatsapp resource.
*/
var (
...
func TestMain(m *testing.M) {
	// Run setup function before starting the test suite for the conversations_messaging_integrations_whatsapp package
	initTestResources()

	// Run the test suite for the conversations_messaging_integrations_whatsapp package
	m.Run()
}
