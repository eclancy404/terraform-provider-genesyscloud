...
func patchTaskManagementWorktypeStatus(worktypeId string, statusId string, body *Workitemstatusupdate, a *platformclientv2.TaskManagementApi) (*platformclientv2.Workitemstatus, *platformclientv2.APIResponse, error) {
	c := customapi.NewClient(a.Configuration, ResourceType)
	path := "/api/v2/taskmanagement/worktypes/" + worktypeId + "/statuses/" + statusId
	return customapi.Do[platformclientv2.Workitemstatus](context.Background(), c, customapi.MethodPatch, path, body, nil)
}
